...
save_to_pdf = FunctionTool(
    save_pdf,
    description=(
        "Save complete XeLaTeX content as a PDF file. "
        "Input: (content: str, filename: str, std_path: str) "
        "Output: The path to the saved PDF file. "
        "content: A full compilable XeLaTeX document generated by the report agent. "
        "filename: The desired filename for the PDF (e.g., 'report.pdf'). "
        "std_path: The directory where the PDF should be written."
    ),
)
